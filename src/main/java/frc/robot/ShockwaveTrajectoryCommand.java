 ...
 */
public class ShockwaveTrajectoryCommand extends CommandBase {
   ...
   */
  public ShockwaveTrajectoryCommand(
  ...
  public void initialize() {
    ...
    fatPrint("Init: Previous speeds: " + m_prevSpeeds);
    m_timer.reset();
    m_timer.start();
    if (m_usePID) {
  ...
  public void execute() {
    ...
    if (m_usePID) {
      fatPrint("Previous speeds: " + m_prevSpeeds);
  ...
  public static void fatPrint(String message) {
